...
import {
    ArrCreateDownloadClientRequest,
    CreateDownloadClientRequestField,
    createDownloadClientRequestSkeleton,
} from '../types/requests/arr/CreateDownloadClientRequest';
import {
    CreateIndexerRequest,
    createIndexerRequestSkeleton,
    createIndexRequestFieldsSkeleton,
} from '../types/requests/arr/CreateIndexerRequest';
import {
    CreateProwlarrIndexerRequest,
    createProwlarrIndexerRequestSkeleton,
} from '../types/requests/arr/CreateProwlarrIndexerRequest';
...
const arrService = {
    createUpdateDownloadClient: async (
        form: CreateDownloadClientForm,
        config: ArrConfig,
        prowlarr: boolean = false,
    ...
    getDownloadClient: async (
        id: number,
        { API_KEY, HOST }: ArrConfig,
        prowlarr: boolean
    ): Promise<DownloadClientResponse | undefined> => {
    ...
    createUpdateIndexer: async (
        form: CreateIndexerForm,
        config: ArrConfig,
        allowCreate: boolean = true
    ): Promise<number> => {
    ...
    createUpdateProwlarrIndexer: async (
        form: CreateIndexerForm,
        config: ArrConfig,
        allowCreate: boolean = true
    ): Promise<number> => {

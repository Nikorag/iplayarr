...
export function calculateSeasonAndEpisode(programme: IPlayerProgramMetadata) : [ type: VideoType, allCategories : string[], episode?: number, episodeTitle?: string, series?: number ] {
    ...
    return [ type, allCategories, episode, episodeTitle, series ];
}